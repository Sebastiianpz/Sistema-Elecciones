...
public class LoadForm extends HttpServlet{
	...
	private static String RODADO_FORM ="rodado/rodadoForm.jsp";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		}else if(req.getParameter("form").equals("rodadoForm") && session.getAttribute("CURRENT_USER") != null) {
			req.getRequestDispatcher(RODADO_FORM).forward(req, resp);
		}else {
